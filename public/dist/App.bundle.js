...
function ajaxHeart(e) {
    ...
    _axios2.default.post(this.action).then(function (res) {
        ...
        if (isHearted) {
            ...
            setTimeout(function () {
                return _this.heart.classList.remove('heart__button--float', 2500);
            });
        }
    }).catch(console.error);
}
...
function loadPlaces(map) {
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        //when click on the marker then show the details of that 
...
function searchResultsHTML(assesments) {
    return assesments.map(function (assesment) {
        return '\n        <a href="/assesment/' + assesment.slug + '" class="search__result" >\n            <strong>' + assesment.name + '</strong>\n        </a>\n        ';
    }).join('');
}
